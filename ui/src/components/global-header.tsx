...
function DesktopMenuLinks() {
  return (
    <Stack
      ...
      fontSize="15px"
    >
      <MenuLink text={'Registry'} link={Links.register} />
      <MenuLink text={'Register'} link={Links.registry} />
    ...
    <>
      ...
      {isOpen && (
        <Stack
          ...
          zIndex={999}
        >
          <Link href={Links.registry}>Register</Link>
          <Link href={Links.register}>Registry</Link>
